...
/****************************************************************************
    included files for Invoicetome
****************************************************************************/
...
if(isset($_POST['sendEmail']) || isset($_POST['send']))
{
    ...
    ****************************************************************************/
    ...
    //Set footer note
    $invoice->setFooternote("https://shameem.me");
...
<head lang="en">
    ...
    <title>Invoicetome - By Shameem Reza</title>
...
<body>
    ...
    <header>
        <div class="container">
            ...
            <h1>
                Invoicetome
                <small>Invoices Generator by <a href="https://shameem.me">Shameem Reza</a></small>
            </h1>
            <a class="logo" href="http://shameem.me"><img src="images/shameem.png" alt="Shameem Reza"/></a>
        </div>
    </header>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="preview-panel">
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-control-static">You've received an invoice from <span id="prevName">Shameem Reza</span></p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="preview-msg-pnl">
                                <div class="preview-msg">
                                    <h2><span id="emailHeading">Shameem Reza</span></h2>
                                    <p>Greetings</p>
                                    <p>You've received an invoice from <span id="emailSub">Shameem Reza</span></p>
                                    <p>You will find a PDF attached.</p>
                                    <p id="prevMesg"></p>
                                    <p><small><strong>Invoicetome</strong> - Invoices generator by <a href="https://shameem.me" target="_blank">Shameem Reza</a></small></p>
                                </div>
                            </div>
                        </div>
    ...
    <footer>
        <div class="container">
            <p class="pull-left">&copy 2019 Creative Commons Attribution 3.0 Unported License.</p>
            <p class="pull-right">Developed by <a href="http://shameem.me" target="_blank">Shameem Reza</a>.</p>
        </div>
    </footer>
