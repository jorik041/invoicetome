...
class invoicetome extends FPDF_Rotate
{
    ...
    function email($to,$from,$subject,$message,$sendToMe,$nameVal){
        ...
        $body .= $message.$eol;
        $body .= '</p>';
        $body .= '<p style="margin-top:20px;clear:both;font-size:10px;"><strong>Invoicetome</strong> - By <a href="https://shameem.me" target="_blank">Shameem Reza</a></p>';
        $body .= $eol;
